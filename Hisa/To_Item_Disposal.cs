...
namespace Hisa
{
    public partial class To_Item_Disposal : Form
    {
        ReportDocument crystal = new ReportDocument();
        public To_Item_Disposal()
        {
            InitializeComponent();
        }
        ...
        //LOAD
        private void To_Item_Disposal_Load(object sender, EventArgs e)
        {
            label1.Text = Print_Item_Disposal.record_number;
