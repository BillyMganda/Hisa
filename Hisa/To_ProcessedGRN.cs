...
namespace Hisa
{
    public partial class To_ProcessedGRN : Form
    {
        ReportDocument crystal = new ReportDocument();
        public To_ProcessedGRN()
        {
            InitializeComponent();
        }
       ...
       //LOAD
        private void To_ProcessedGRN_Load(object sender, EventArgs e)
        {
            label1.Text = Processed_GRN.GRN_Number;
            try
            {
