...
namespace Hisa
{
    public partial class Cart_Purchasing : Form
    {
        public Cart_Purchasing()
        {
            InitializeComponent();
        }
        ...
        //LOAD
        private void Cart_Purchasing_Load(object sender, EventArgs e)
        {
            Load_RequestNumber();
            ...
            txtRequestBy.Text = Choose_Department_Purchasing.User_Account;
            txtDepartment.Text = Choose_Department_Purchasing.User_department;
