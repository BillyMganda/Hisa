...
namespace Hisa
{
    public partial class Cart_Statistics : Form
    {
        public Cart_Statistics()
        {
            InitializeComponent();
        }
        ...
        //LOAD
        private void Cart_Statistics_Load(object sender, EventArgs e)
        {
            Load_RequestNumber();
            ...
            txtRequestBy.Text = Choose_Department_Statistics.user;
            txtDepartment.Text = Choose_Department_Statistics.dpt;
