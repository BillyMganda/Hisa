...
namespace Hisa
{
    public partial class To_ReturnToSupplier : Form
    {
        ReportDocument crystal = new ReportDocument();
        public To_ReturnToSupplier()
        {
            InitializeComponent();
        }
        ...
        //LOAD
        private void To_ReturnToSupplier_Load(object sender, EventArgs e)
        {
            label1.Text = Print_Return_To_Supplier.record_number;
            try
            {
