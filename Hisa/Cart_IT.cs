...
namespace Hisa
{
    public partial class Cart_IT : Form
    {
        public Cart_IT()
        {
            InitializeComponent();
        ...
        //LOAD
        private void Cart_IT_Load(object sender, EventArgs e)
        {
            Load_RequestNumber();
            ...
            txtRequestBy.Text = Choose_Department_IT.User_Account;
            txtDepartment.Text = Choose_Department_IT.User_department;
