...
namespace Hisa
{
    public partial class Choose_Department_Purchasing : Form
    {
        public Choose_Department_Purchasing()
        {
            InitializeComponent();
        }
        string Department;
        ...
        private void Choose_Department_Purchasing_Load(object sender, EventArgs e)
        {
            label1.Text = Purchasing.SetValueForText2;
        }
        ...
        private void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            Hide();
            Cart_Purchasing cart=new Cart_Purchasing();
            cart.ShowDialog();
        }
    }
}
